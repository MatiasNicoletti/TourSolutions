      ...
      myGebDirections.route({
        ...
        function(directionsResult, directionsStatus) {
          if (directionsStatus == google.maps.DirectionsStatus.OK) {
            ...
            alert("No se ha podido calcular una ruta en base a las ubicaciones seleccionadas. Por favor ingréselas nuevamente.");
            doNotContinue = true;
          } else {
    ...
    myGebDirections.route({
      ...
      function(directionsResult, directionsStatus) {
        if (directionsStatus == google.maps.DirectionsStatus.OK) {
          ...
          var errorMsg = "Por favor revise las siguientes ubicaciones: ";
          for (var i = 0; i < failedAddrArr.length; ++i) {
            errorMsg += failedAddrArr[i];
            if (i < failedAddrArr.length - 1) {
              errorMsg += ", ";
    ...
    gebGeocoder.geocode({
      ...
      if (status == google.maps.GeocoderStatus.OK) {
        ...
        if (address.indexOf(",") != -1) {
          ...
          --addressRequests;
          alert("No se ha podido ubicar: " + address + ". Try removing the town or postal code part of the address");
          ++currQueueNum;
          addressProcessing = false;
          if (typeof(callback) == 'function')
            callback(address);
